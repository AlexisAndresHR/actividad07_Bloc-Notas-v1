 ...
 * @author Andy
 */
public class ViewBlocNotasv1 extends javax.swing.JFrame {

    /**
     * Creates new form viewBlocNotasv1
     */
    public ViewBlocNotasv1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBlocNotasv1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewBlocNotasv1().setVisible(true);
            }
        });
    }
